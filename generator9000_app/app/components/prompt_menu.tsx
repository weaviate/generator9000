...
const PromptMenuComponent: React.FC<PromptMenuComponentProps> = ({ prompt, imagePrompt, selectedTemplate, templates, dataFields, setPrompt, setImagePrompt, setDataFields, setSelectedTemplate }) => {
